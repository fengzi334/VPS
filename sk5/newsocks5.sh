...
wget --no-check-certificate  -P /tmp https://raw.githubusercontent.com/fengzi334/VPS/main/sk5/gost.tar.gz
if [[ ! -f "/tmp/gost.tar.gz" ]]; then
 echo -e "\033[41m"下载失败请检查网络，或者联系脚本作者 WX：d1083773908"\033[0m"&&set -e
else
 echo 再等等吧！ 就要好了！！！
fi
